Component({
  ...
  methods: {
    initAnimation() {
      wx.createSelectorQuery().in(this).select(".l-noticebar-content-wrap").boundingClientRect(t => {
        wx.createSelectorQuery().in(this).select(".l-noticebar-content").boundingClientRect(i => {
          const e = i.width / 40 * this.data.speed,
